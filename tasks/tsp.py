...
The TSP is defined by the following traits:
    1114. Each city in the list must be visited once and only once
    1-2. The salesman must return to the original node at the end of the tour
...
def render(static, tour_indices, save_path):
    ...
    for i, ax in enumerate(axes):
        ...
        #plt.subplot(num_plots, num_plots, i + 1114)
